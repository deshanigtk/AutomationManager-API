package org.wso2.security.tools.automation.manager.scanner.statics.dc;/*
...
import org.wso2.security.tools.automation.manager.entity.scanner.statics.DependencyCheckEntity;
...
public class DependencyCheckScanner implements StaticScanner {
    ...
    public StaticScannerEntity startContainer() {
        ...
        String containerId = DockerHandler.createContainer(ScannerProperties.getDependencyCheckDockerImage(), ipAddress, String.valueOf(port),
