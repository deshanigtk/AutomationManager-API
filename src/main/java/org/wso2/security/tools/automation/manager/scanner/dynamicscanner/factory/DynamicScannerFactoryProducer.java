...
public class DynamicScannerFactoryProducer {
    public static AbstractDynamicScannerFactory getAbstractDynamicScannerFactory(String factoryType) {
        if ("cloudBased".equalsIgnoreCase(factoryType)) {
            return new CloudBasedDynamicScannerFactory();
        }
        if ("containerBased".equalsIgnoreCase(factoryType)) {
